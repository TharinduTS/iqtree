...
Working in cedar iqtree_with_thinned_data_2025

Copied my vcf there 
trop_only_allchrs_concat_maxmissingcount_0_biallelic_genoqual30.vcf.gz

Then copied vcf2phylip script there
...
Then I converted vcf file to phylip and fasta with the help of vcf2phylip script
...
#SBATCH --mem=64gb
#SBATCH --output=phylip.%J.out
#SBATCH --error=phylip.%J.err
...
python vcf2phylip.py --input trop_only_allchrs_concat_maxmissingcount_0_biallelic_genoqual30.vcf.gz -f
```
downloaded and installed iqtree
```
wget https://github.com/iqtree/iqtree2/releases/download/v2.4.0/iqtree-2.4.0-Linux-intel.tar.gz
tar -xvf iqtree-2.4.0-Linux-intel.tar
```
Then selected best fit model
```
#!/bin/sh
#SBATCH --job-name=fst
#SBATCH --nodes=1
...
Copied the nexus file to computecanada mtDNA folder

it gave me the best fit model
